<template>
    <div id="app">
        ...
        <overlay
            ...
            @visibility-changed="hideWelcome"
            ref="welcomeOverlay"
            dismissable
        >
        ...
        <overlay :visible="state.showSongDetails" dismissable>
            <song-details-overlay :song="state.song"></song-details-overlay>
        </overlay>

        <overlay :visible="state.showSettings" dismissable>
...
export default {
    ...
    computed: {
        ...
        tabTitle() {
            ...
            const base = state.song.name
                ? `${state.song.name} - nbsplayer`
                : "nbsplayer";
    ...
    methods: {
        ...
        hideWelcome(val) {
            if (val) state.showWelcome = true;
            else state.showWelcome = false;
        },
    },
};
</script>
