...
<template>
    <div class="toolbar">
        ...
        <a @click="toggleLoop" :value="options.loop" title="Loop" class="button">
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            this.state.editor!.modified = false;
        },
    },
};
</script>
