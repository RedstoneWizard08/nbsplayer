...
export const instruments = [
    new Instrument("Harp", 0, harp_sound, harp_texture, harp_icon, harp_toolbar, true),
    new Instrument("Double Bass", 1, dbass_sound, dbass_texture, dbass_icon, dbass_toolbar, false),
    new Instrument("Bass Drum", 2, bdrum_sound, bdrum_texture, bdrum_icon, bdrum_toolbar, false),
    new Instrument("Snare Drum", 3, sdrum_sound, sdrum_texture, sdrum_icon, sdrum_toolbar, false),
    new Instrument("Click", 4, click_sound, click_texture, click_icon, click_toolbar, false),
    new Instrument("Guitar", 5, guitar_sound, guitar_texture, guitar_icon, guitar_toolbar, false),
    new Instrument("Flute", 6, flute_sound, flute_texture, flute_icon, flute_toolbar, false),
    new Instrument("Bell", 7, bell_sound, bell_texture, bell_icon, bell_toolbar, false),
    new Instrument("Chime", 8, chime_sound, chime_texture, chime_icon, chime_toolbar, false),
    new Instrument(
        "Xylophone",
        9,
        xylophone_sound,
    ...
    new Instrument("Bit", 13, bit_sound, bit_texture, bit_icon, bit_toolbar, false),
    new Instrument("Banjo", 14, banjo_sound, banjo_texture, banjo_icon, banjo_toolbar, false),
    new Instrument("Pling", 15, pling_sound, pling_texture, pling_icon, pling_toolbar, false),
];
